...
function updateVisualization() {
    ...
    vizDiv.innerHTML = `
        <div class="color-legend">
            <div style="padding: 8px 4px; color: black; font-size: 10px; font-weight: bold; line-height: 1.1; text-align: center; z-index: 12; display: flex; flex-direction: column; justify-content: space-evenly; height: 100%;">
